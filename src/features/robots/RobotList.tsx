...
const RobotList = ({
  ...
  return items ? (
    <>
      <div className={window.location.href.endsWith("?filter=portfolio") ? "grid grid-cols-4 text-base font-bold text-primary space-x-3 sm:space-x-14" : "grid grid-cols-3 text-base font-bold text-primary space-x-5 sm:space-x-24 "}>
        <div
        ...
        >
          ...
          <div
            className={window.location.href.endsWith("?filter=sell") || window.location.href.endsWith("?filter=portfolio") ? "flex col-span-1 items-center pl-4 sm:px-3 cursor-pointer text-sm sm:text-lg hover:text-high-emphesis" : "hidden"}
          ...
          <div
            className={window.location.href.endsWith("?filter=buy") || window.location.href.endsWith("?filter=portfolio") ? "flex items-center col-span-1 pl-4 sm:px-2 cursor-pointer text-sm sm:text-lg hover:text-high-emphesis" : "hidden"}
