...
const PriceRatio2: FC<{ currencies: { [field in Field]?: Currency }, currentPrice: Price<Currency, Currency>, parsedAmounts: { [field in Field]?: CurrencyAmount<Currency> } }> = ({ currencies, currentPrice, parsedAmounts }) => {
