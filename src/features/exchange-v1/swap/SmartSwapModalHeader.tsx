...
import { AdvancedSmartSwapDetails } from './AdvancedSmartSwapDetails'
...
export default function SmartSwapModalHeader({
  trade,
  allowedSlippage,
  feePercent,
  recipient,
  ...
  return (
    <div className="grid gap-4">
      ...
      <AdvancedSmartSwapDetails trade={trade} allowedSlippage={allowedSlippage} feePercent={feePercent} minerBribe={minerBribe} />
