...
export default function Stake() {
  ...
  return (
    <Container id="bar-page" className="py-4 md:py-8 lg:py-12" maxWidth="full">
      <Head>
        <title key="title">Stake | KDORNA</title>
        <meta
          key="description"
          name="description"
          content="Stake KDORNA in return for xKDORNA, an interest bearing and fungible SEP20 token designed to share revenue generated by all KDORNA products."
        />
        <meta key="twitter:url" name="twitter:url" content="https://app.TANGOswap.fi/stake" />
        <meta key="twitter:title" name="twitter:title" content="STAKE KDORNA" />
        <meta
        ...
        <meta key="og:title" property="og:title" content="STAKE KDORNA" />
          ...
          <div className="flex flex-col w-full max-w-xl mt-auto mb-2">
            <div className="flex max-w-lg">
              <div className="self-end mb-3 text-lg font-bold md:text-2xl text-high-emphesis md:mb-7">
                {i18n._(t`Maximize yield by staking KDORNA for xKDORNA`)}
              </div>
              {/* <div className="self-start pl-6 pr-3 mb-1 min-w-max md:hidden">
                                <img src={XSushiSignSmall} alt="xKDORNA sign" />
                            </div> */}
            </div>
            <div className="max-w-lg pr-3 mb-2 text-sm leading-5 text-gray-500 md:text-base md:mb-4 md:pr-0">
              {i18n._(t`For every swap on the exchange on every chain, 0.05% of the swap fees are distributed as KDORNA
                                proportional to your share of the KDORNABar. When your KDORNA is staked into the Bar, you receive
                                xKDORNA in return.
                                Your xKDORNA is continuously compounding, when you unstake you will receive all the originally deposited
                                KDORNA and any additional from fees.`)}
            </div>
            {/* <div className="flex">
                            ...
                            <div>
                                <StyledLink className="text-sm text-lg whitespace-nowrap md:text-lg md:leading-5">
                                    Tips for using xKDORNA
                                </StyledLink>
                            </div>
                        </div> */}
          </div>
          <div className="hidden px-8 ml-6 md:block w-72">
            <Image src="/xtango-sign.png" alt="xKDORNA sign" width="100%" height="100%" layout="responsive" />
          </div>
        </div>
              ...
              <div className="w-full max-w-xl px-3 pt-2 pb-6 rounded bg-dark-900 md:pb-9 md:pt-4 md:px-8">
                ...
                <div className="flex items-center justify-between w-full mt-6">
                  <p className="font-bold text-large md:text-2xl text-high-emphesis">
                    {activeTab === 0 ? i18n._(t`Stake KDORNA`) : i18n._(t`Unstake`)}
                  </p>
                  {/*
                  <div className="border-gradient-r-pink-red-light-brown-dark-pink-red border-transparent border-solid border rounded-3xl px-4 md:px-3.5 py-1.5 md:py-0.5 text-high-emphesis text-xs font-medium md:text-base md:font-normal">
                    {`1 xKDORNA = ${xSushiPerSushi.toFixed(4)} KDORNA`}
                  </div>
                  */
                  }
                </div>
                ...
                <div className="relative w-full h-0 pointer-events-none bottom-14">
                  ...
                  >
                    <div className="flex space-x-2 ">
                      ...
                      >
                        {`${input ? input : '0'} ${activeTab === 0 ? '' : 'x'}KDORNA`}
                      </p>
                    </div>
                ...
                <div className="flex flex-col flex-grow md:mb-14">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-primary">xKDORNA</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col flex-grow">
                  ...
                  <div className="flex items-center ml-8 space-x-4 md:ml-0">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-primary">KDORNA</p>
                    </div>
                  </div>
                </div>
