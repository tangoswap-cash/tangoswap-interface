...
export default function Stake() {
  ...
  return (
    <Container id="bar-page" className="py-4 md:py-8 lg:py-12" maxWidth="full">
      <Head>
        <title key="title">Stake | MONTOTO</title>
        <meta
          key="description"
          name="description"
          content="Stake MONTOTO in return for xMONTOTO, an interest bearing and fungible SEP20 token designed to share revenue generated by all MONTOTO products."
        />
        <meta key="twitter:url" name="twitter:url" content="https://app.TANGOswap.fi/stake" />
        <meta key="twitter:title" name="twitter:title" content="STAKE MONTOTO" />
        <meta
        ...
        <meta key="og:title" property="og:title" content="STAKE MONTOTO" />
          ...
          <div className="flex flex-col w-full max-w-xl mt-auto mb-2">
            <div className="flex max-w-lg">
              <div className="self-end mb-3 text-lg font-bold md:text-2xl text-high-emphesis md:mb-7">
                {i18n._(t`Maximize yield by staking MONTOTO for xMONTOTO`)}
              </div>
              {/* <div className="self-start pl-6 pr-3 mb-1 min-w-max md:hidden">
                                <img src={XSushiSignSmall} alt="xMONTOTO sign" />
                            </div> */}
            </div>
            <div className="max-w-lg pr-3 mb-2 text-sm leading-5 text-gray-500 md:text-base md:mb-4 md:pr-0">
              {i18n._(t`For every swap on the exchange on every chain, 0.05% of the swap fees are distributed as MONTOTO
                                proportional to your share of the MONTOTOBar. When your MONTOTO is staked into the MONTOTOBar, you receive
                                xMONTOTO in return.
                                Your xMONTOTO is continuously compounding, when you unstake you will receive all the originally deposited
                                MONTOTO and any additional from fees.`)}
            </div>
            {/* <div className="flex">
                            ...
                            <div>
                                <StyledLink className="text-sm text-lg whitespace-nowrap md:text-lg md:leading-5">
                                    Tips for using xMONTOTO
                                </StyledLink>
                            </div>
                        </div> */}
          </div>
          <div className="hidden px-8 ml-6 md:block w-72">
            <Image src="/xtango-sign.png" alt="xMONTOTO sign" width="100%" height="100%" layout="responsive" />
          </div>
        </div>
                ...
                <div className="relative w-full h-0 pointer-events-none bottom-14">
                  ...
                  >
                    <div className="flex space-x-2 ">
                      ...
                      >
                        {`${input ? input : '0'} ${activeTab === 0 ? '' : 'x'}MONTOTO`}
                      </p>
                    </div>
                ...
                <div className="flex flex-col flex-grow md:mb-14">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-primary">xMONTOTO</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col flex-grow">
                  ...
                  <div className="flex items-center ml-8 space-x-4 md:ml-0">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-primary">MONTOTO</p>
                    </div>
                  </div>
                </div>
