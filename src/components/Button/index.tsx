...
const FILLED = {
  ...
  red: 'bg-dark-red bg-opacity-80 w-full rounded text-high-emphesis hover:bg-opacity-100 disabled:bg-opacity-80',
  'wax-flower':
    'bg-wax-flower bg-opacity-80 w-full rounded text-high-emphesis hover:bg-opacity-100 disabled:bg-opacity-80',
  ...
  gradient:
    'w-full text-high-emphesis border rounded border-dark-800 bg-gradient-to-r from-opaque-red to-light-brown  opacity-80 hover:opacity-100 disabled:bg-opacity-80',
  brown: 'bg-brown bg-opacity-80 w-full rounded text-high-emphesis hover:bg-opacity-100 disabled:bg-opacity-80',
}

const OUTLINED = {
  default: 'bg-transparent opacity-80 hover:opacity-100',
  red: 'bg-red bg-opacity-20 outline-red rounded text-red hover:bg-opacity-40 disabled:bg-opacity-20',
  'wax-flower': 'bg-wax-flower bg-opacity-20 outline-blue rounded text-blue hover:bg-opacity-40 disabled:bg-opacity-20',
  ...
  gradient:
    'border rounded text-high-emphesis border-dark-800 bg-gradient-to-r from-opaque-red to-light-brown opacity-80 hover:opacity-100 disabled:bg-opacity-20',
}
...
export type ButtonColor = 'blue' | 'pink' | 'gradient' | 'gray' | 'default' | 'red' | 'green' | 'brown'
