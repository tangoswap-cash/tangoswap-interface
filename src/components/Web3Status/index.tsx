  ...
  if (account) {
    return (
      <div
        ...
        className="flex items-center px-3 py-2 text-sm rounded-lg bg-light-brown bg-opacity-20"
    ...
    return <Web3Connect style={{ paddingTop: '6px', paddingBottom: '6px', backgroundColor: '#651906' }} />
  }
}
