...
import TransactionSettings from '../TransactionSettingsSmart'
...
export default function SettingsTab(
  { placeholderSlippage, placeholderFeePercent }: { placeholderSlippage?: Percent, placeholderFeePercent?: Percent }
  // { placeholderSlippage }: { placeholderSlippage?: Percent },
  // { placeholderFeePercent }: { placeholderFeePercent?: Percent }
) {
      ...
      {open && (
        <div className="absolute top-14 right-0 z-50 -mr-2.5 min-w-20 md:m-w-22 md:-mr-5 bg-dark-900 border-2 border-dark-800 rounded w-80 shadow-lg">
          <div className="p-4 space-y-4">
            ...
            <TransactionSettings placeholderFeePercent={placeholderFeePercent} />
